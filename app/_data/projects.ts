...
export const projects: Project[] = [
  ...
  },
  {
    ...
    slug: "truehire",
    description:
      "Full-stack freelancer marketplace connecting clients with freelancers. Next.js, Stripe, AI & real-time messaging.",
    tags: [
      "Next.js",
      "Stripe",
      "Clerk",
    ...
    longDescription:
      "TrueHire is a full-stack freelancer marketplace that connects clients with skilled freelancers. Clients can post and manage jobs, accept proposals, pay freelancers securely, and send invoices. Freelancers create profiles, submit proposals, subscribe for higher proposal limits and AI financial assistance, receive payments, and use real-time messaging. The platform includes advanced search for jobs and freelancers, reviews and ratings, and Chart.js analytics for income and expenses. Built as a scalable SaaS combining payments, subscriptions, messaging, and AI in one system.",
    features: [
      "Client job posting, editing, and management with open and in-progress job views",
      "Freelancer proposals, profile (skills, experience, portfolio), and secure payments",
      "Subscription-based freelancer accounts (increased proposal limit, AI assistant access)",
      "AI-powered financial assistant for freelancers",
      "Real-time messaging between clients and freelancers (Ably)",
      "Reviews and rating system for freelancers",
      "Advanced search: freelancers by skills, rating, name; jobs by skill, budget, client name",
      "Invoicing and Stripe payment integration",
      "Chart.js analytics: monthly and per-job expenses/income",
      "Wireframes and database planning (users, clients, freelancers, jobs, contracts, conversations, messages, reviews)",
    ],
    tech: [
      "Next.js",
      "React",
    ...
    thumbnail: "/projects/truehire/TH-HomePage.png",
    images: [
      "/projects/truehire/TH-HomePage.png",
      "/projects/truehire/TH-FindFreelancers.png",
      "/projects/truehire/TH-FreelancerProfile.png",
      "/projects/truehire/TH-Inbox.png",
      "/projects/truehire/TH-JobAnalytics.png",
      "/projects/truehire/TH-Plans.png",
      "/projects/truehire/TH-Portal.png",
      "/projects/truehire/TH-FindJobs.png",
    ],
    category: "web",
    website: "https://true-hire-mp.vercel.app/",
    github: "https://github.com/Dylan-JM/week12-assignment",
  },
  {
    title: "Blue Sky Realty",
    slug: "blueskyrealty",
    description:
      "Full-stack property listing platform with role-based access, advanced filtering, and Azure cloud deployment. ASP.NET Core, SQL Server & OAuth.",
    tags: [
      "ASP.NET Core",
      "C#",
      "SQL Server",
    ...
    longDescription:
      "Blue Sky Realty is a full-stack property listing platform built with ASP.NET Core MVC. Users can browse and filter UK properties by price, area, bedrooms, bathrooms, garage, county, and city. The platform features role-based access control for Admin, Sales, and User roles, with Microsoft Entra ID OAuth for authentication. Cities are dynamically populated via the GeoNames API. The application is deployed on Azure with SQL Server, using Entity Framework Core for data access and Serilog for structured logging. Property data is seeded automatically with realistic listings.",
    features: [
      "Advanced property filtering by price, area, bedrooms, bathrooms, garage, county, and city",
      "Role-based access control for Admin, Sales, User, and Anonymous roles",
      "Microsoft Entra ID OAuth authentication",
      "Dynamic city dropdown populated via GeoNames API",
      "Pagination for property listings",
      "Azure SQL Server deployment with Entity Framework Core",
      "Structured logging and monitoring with Serilog",
      "Automatic data seeding with realistic property listings",
    ],
    tech: [
      "ASP.NET Core MVC",
      "C#",
    ...
    thumbnail: "/projects/bsr/BSR-HomePage.png",
    images: [
      "/projects/bsr/BSR-HomePage.png",
      "/projects/bsr/BSR-AddHome.png",
      "/projects/bsr/BSR-AdminPanel.png",
      "/projects/bsr/BSR-UpdateUser.png",
    ],
    category: "web",
    website: "https://bsr-app-cgbdamdye7cwbsfx.westeurope-01.azurewebsites.net",
    github: "https://github.com/Dylan-JM/BSR",
  },
  {
    title: "Converso SaaS",
    slug: "converso",
    ...
    features: [
      ...
      "Sentry: Allow for developers to see detailed error tracking and performance monitoring tools",
    ],
    tech: [
      "TypeScript",
      "Next.js",
  ...
  },
  {
    ...
    tech: ["React", "React Router", "Express", "Node.js", "SQL", "PostgreSQL"],
